...
class Config(BaseConfig):
    ...
    def __init__(self):
        ...
        self.problem_specifics = {
            "num_jobs": 30,  # number of jobs
            "num_machines": 20,  # number of machines
            "num_operations": 20,  # number of operations, should be equal to machines
        ...
        self.num_simulations = 100  # Number of search simulations in GAZ's tree search
        # ----

        self.singleplayer_options = {
            "method": "single",
            "bootstrap_final_objective": False,
        ...
        self.num_experience_workers = 10  # Number of actors (processes) which generate experience.
        ...
        self.arena_set_path = "./test/JSSP/jsp_20_20_arena.npy"  # Path to the arena set.
        self.num_arena_games = 20  # Number of arena games to play.
        ...
        self.log_policies_for_moves = [1, 100, 300]  # Logs probability distributions for numbered moves
        ...
        self.validation_set_path = "./test/JSSP/jsp_30_20_validation.npy"
        self.test_set_path = "./test/JSSP/jsp_30_20_test.npy"

...
class Config(BaseConfig):
    ...
    def __init__(self):
        ...
        self.singleplayer_options = {
            ...
            "baseline": {
                # If this is set to `True`, `num_trajectories` are sampled and meaned for the timestep-wise baseline value.
                # If set to `False` greedy rollout is used.
                "sample": False,
                "num_trajectories": 1
            },
        ...
        self.num_experience_workers = 1  # Number of actors (processes) which generate experience.

...
class Config(BaseConfig):
    ...
    def __init__(self):
        ...
        self.gumbel_test_greedy_rollout = True  # If True, then in evaluation mode the policy of the learning actor is rolled out greedily (no MCTS)
        ...
        self.arena_set_path = "./test/TSP/tsp_50_arena.npy"  # Path to the arena set.
        ...
        self.log_policies_for_moves = [1, 25, 40]  # Logs probability distributions for numbered moves
        ...
        self.validation_set_path = "./test/TSP/tsp_50_validation.pickle"
        self.test_set_path = "./test/TSP/tsp_50_seed1234.npy"

...
class Config(BaseConfig):
    ...
    def __init__(self):
        ...
        self.gumbel_is_gt = True  # If True, we use the variant GAZ PTP GT, where the greedy actor is also simulated greedily by the learning actor.
        self.num_simulations = 20  # Number of search simulations in GAZ's tree search
        # ----
